...
unsigned int nStakeMinAge = 10 * 60; // 15 minute
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "THcoin";
        CTransaction txNew;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xf919373a2cc51736712800419435d5bb6b188d82c04192e2819870c159adc6ec"));
        block.print();
